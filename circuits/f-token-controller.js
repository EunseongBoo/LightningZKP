...
const contract from 'truffle-contract';
const config from 'config';
const jsonfile from 'jsonfile';
// eslint-disable-next-line const/extensions
const zokrates from '@eyblockchain/zokrates.js';
const fs from 'fs';
const zkp from './f-token-zkp';
const { computeVectors, computePath, checkRoot } from './compute-vectors';
const Element from './Element';

const Web3 from './web3';
const { getContract } from './contractUtils';
const utils from './zkpUtils';
