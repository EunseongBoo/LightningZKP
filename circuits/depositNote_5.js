...
function getCreateNoteParams(_spk, _ssk, _mpk, _rpk, _ovalue, _nvalue, _notenum, _ononce, _snonce0, _snonce1, _snonce2, _snonce3, _snonce4, _rnonce0, _rnonce1, _rnonce2, _rnonce3, _rnonce4, _cnonce) {
  ...
  let publicParams = oh.concat(sh1, sh2, sh3, sh4, sh5, rh1, rh2, rh3, rh4, rh5, ch, [mpk.slice(0,32), mpk.slice(32, 64), mpk.slice(64, 96), mpk.slice(96), notenum, nvalue]);
  let privateParams = [ovalue, ononce, snonce1, snonce2, snonce3, snonce4, snonce5, rnonce1, rnonce2, rnonce3, rnonce4, rnonce5, cnonce, spk.slice(0,32), spk.slice(32,64), spk.slice(64,96), spk.slice(96), ssk, rpk.slice(0,32), rpk.slice(32,64), rpk.slice(64,96), rpk.slice(96)]
