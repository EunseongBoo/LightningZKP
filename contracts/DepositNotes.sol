...
contract DepositNotes is DepositNoteVerifier, ZkDaiBase {
  uint8 internal constant NUM_PUBLIC_INPUTS = 15;
  ...
  */
    ...
    internal
  {
      ...
      bytes32[NUM_DEPOSIT_NOTES+1] memory _notes = get5Notes(submission.publicInput);
  ...
  function get5Notes(uint256[] memory input)
    internal
    pure
